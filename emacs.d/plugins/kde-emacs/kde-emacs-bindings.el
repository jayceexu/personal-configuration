...
;;       (define-key global-map [(f13)] 'igrep-find)  ; on the console, shift f2 gives f12 for some reason..
...
;; (define-key global-map [(shift f7)] 'makeclean)
;; (define-key global-map [(f7)] 'make)
...
;; (define-key c-mode-map [(f6)] 'kde-switch-cpp-h)
;; (define-key c++-mode-map [(shift f6)] 'switch-to-function-def)
;; (define-key c-mode-map [(shift f6)] 'switch-to-function-def)
